...
ans4 :: ATens 0 1 0 0 0 0 AnsVarR
ans4 = ans4'
  where
    (_, _, ans4') = mkAnsatzTensorFastAbs 4 symList4 areaList4 :: (AnsatzForestEta, AnsatzForestEpsilon, ATens 0 1 0 0 0 0 AnsVarR)
...
ans4Fail1 = case ans4Dec of
                ...
                Right _ -> False
  where
    ans4Dec = decodeTensor ans4Enc :: Either String (ATens 0 1 0 0 0 0 (SField Double))
...
ans4Fail2 = case ans4Dec of
                ...
                Right _ -> False
  where
    ans4Dec = decodeTensor ans4Enc :: Either String (STTens 2 0 AnsVarR)
